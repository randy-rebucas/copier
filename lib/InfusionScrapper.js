...
class InfusionScrapper {
    ...
    async loadItems(page, callback) {
        ...
        if (this.hasMoreItems(page)) {
            ...
            this.createItems((output) => {

                this.loadItems(output, callback);
    ...
    async requesItems(page) {
        ...
        console.log(`${process.env.BASE_URL}/${this.module}?${queryParams}`);
        // limit=1000&offset=77&order=id&order_direction=DESCENDING
